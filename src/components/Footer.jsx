...
const Footer = () => {
    ...
    return (
        <div  data-scroll data-scroll-section      data-scroll-speed="0.8" className='w-full h-[90vh] overflow-hidden mt-[8vw] md:mt-[1vw] md:h-screen px-[4.5vw] gap-[1vw] flex-col justify-between  relative  '>
           
            <div className='md:flex w-full '>
                <div className='w-full md:h-full   '>
                    <div className='leading-none  mb-[2vw] md:-mb-[10vw]'>
                        <h1 className='text-[7vw] font-semibold font-["FounterGrotesk"] uppercase'>EYE-</h1>
                        <h1 className='text-[7vw] font-semibold font-["FounterGrotesk"] uppercase'>OPENING</h1>
                    </div>

                </div>
                <div className='w-full h-full  flex flex-col '>
                    <div>
                        <h1 className='text-[6vw]  tracking-tighter font-["FounterGrotesk"] uppercase mb-[8vw]'>presentations</h1>
                    </div>
                    <div className=''>
                        <div className='mb-[4vw] md:mb-[2vw] font-["NeueMontreal"] '>
                            <h1 className='md:text-[1.5vw] text-[5vw] uppercase'>s:</h1>
                            {["instagram", "behance", "facebook", "linkedin"].map((ele, index) => (<a key={index} className='block underline capitalize cursor-pointer'>
                                {ele}
                            </a>))}
                        </div>
                        <div className='mb-[4vw] md:mb-[2vw] flex justify-between font-["NeueMontreal"]'>
                            <div><h1 className='md:text-[1.5vw] text-[5vw]  uppercase'>l:</h1>
                                {["instagram", "behance", "facebook", "linkedin"].map((ele, index) => (<a key={index} className='block underline capitalize cursor-pointer'>
                                    {ele}
                                </a>))}</div>
                            <div><h1 className=' md:text-[1.5vw] text-[5vw]  uppercase'>m:</h1>
                                {["instagram", "behance", "facebook", "linkedin"].map((ele, index) => (<a key={index} className='block underline capitalize cursor-pointer'>
                                    {ele}
                                </a>))}</div>
                        ...
                        <div className='mb-[4vw] md:mb-[2vw] font-["NeueMontreal"]'>
                            <h1 className='md:text-[1.5vw] text-[5vw]  uppercase'>e:</h1>
                            <a className='underline capitalize cursor-pointer'> hello@ochidesign</a>
            ...
            <div className=' w-full absolute bottom-[8vh]'>
